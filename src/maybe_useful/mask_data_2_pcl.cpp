...
*/
  ...
  ros::NodeHandle nh;
  //ros::Subscriber mask_data = nh.subscribe<dn_object_detect::DetectedObjects>( "/dn_object_detect/detected_objects", 1);
  ...
  pcl_full_pub = nh.advertise<sensor_msgs::PointCloud2> ("/class/full_roi_pcl", 1);
